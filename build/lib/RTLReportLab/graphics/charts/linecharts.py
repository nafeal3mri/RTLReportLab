...
from RTLReportLab.lib.validators import isNumber, isNumberOrNone, isColorOrNone, \
...
from RTLReportLab.graphics.shapes import Line, Rect, Group, Drawing, Polygon, PolyLine
from RTLReportLab.graphics.widgets.signsandsymbols import NoEntry
...
from RTLReportLab.graphics.widgets.markers import uSymbol2Symbol, isSymbol, makeMarker
...
class HorizontalLineChart3D(HorizontalLineChart):
    ...
    def makeLines(self):
        ...
        F = _FakeGroup()
        from RTLReportLab.graphics.charts.utils3d import _make_3d_line_info
...
def sampleCandleStick():
    from RTLReportLab.graphics.widgetbase import CandleSticks
    d = Drawing(400, 200)
