...
from RTLReportLab.graphics.shapes import Line, Rect, Polygon, Drawing, Group, String, Circle, Wedge
from RTLReportLab.graphics import renderPDF
from RTLReportLab.graphics.widgets.signsandsymbols import _Symbol
import copy
