...
from RTLReportLab.lib.utils import open_for_read, makeFileName, isSeq, isBytes, isUnicode, _digester, isStr, bytestr, annotateException, TimeStamp
from RTLReportLab.lib.rl_accel import escapePDF, fp_str, asciiBase85Encode, asciiBase85Decode
...
class PDFStreamFilterBase85Encode:
    ...
    def encode(self, text):
        from RTLReportLab.pdfbase.pdfutils import _wrap
    ...
    def makeContent(self,doc):
        if self.__path:
            if self.__pathContent is None:
                from RTLReportLab.lib.rparsexml import smartDecode
...
class PDFSeparationCMYKColor:
    def __init__(self, cmyk):
        from RTLReportLab.lib.colors import CMYKColor
