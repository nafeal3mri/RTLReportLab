...
from RTLReportLab.lib.enums import TA_LEFT, TA_CENTER, TA_RIGHT, TA_JUSTIFY
...
class paragraphEngine:
    ...
    def __init__(self, program = None):
        ...
        from RTLReportLab.lib.enums import TA_LEFT
        ...
        for opcode in program:
            if isinstance(opcode,str)  or hasattr(opcode,'width'):
                ...
                if indicator=="nextLine":
                    ...
                    #from RTLReportLab.lib.colors import green
...
class Para(Flowable):
    ...
    def compileProgram(self, parsedText, program=None):
        ...
        a( ("face", fn ) )
        from RTLReportLab.lib.fonts import ps2tt
...
class SeqObject(EvalStringObject):
    ...
    def getOp(self, tuple, engine):
        from RTLReportLab.lib.sequencer import getSequencer
...
def handleSpecialCharacters(engine, text, program=None):
    from RTLReportLab.platypus.paraparser import greeks
...
def Paragraph(text, style, bulletText=None, frags=None, context=None):
    ...
    if "&" not in text and "<" not in text:
        ...
        from RTLReportLab.lib import rparsexml
