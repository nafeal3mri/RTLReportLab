...
from RTLReportLab.lib.utils import asNative, base64_decodebytes
...
def _setup():
    from RTLReportLab.pdfbase import pdfmetrics, ttfonts
...
from RTLReportLab.graphics.widgets.signsandsymbols import SmileyFace
def getDrawing11():
    '''test of anchoring'''
...
def smallArrow():
    ...
    from RTLReportLab.graphics.renderPM import _getImage
...
def getDrawing14():
    '''test shapes.Image'''
    from RTLReportLab.graphics.shapes import Image
    D = Drawing(400, 200)
    im0 = smallArrow()
