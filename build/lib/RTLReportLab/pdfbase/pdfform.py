...
from RTLReportLab.pdfbase.pdfdoc import PDFString, PDFStream, PDFDictionary, PDFName, PDFObject
from RTLReportLab.lib.colors import obj_R_G_B
...
from RTLReportLab.pdfbase.pdfpattern import PDFPattern, PDFPatternIf
...
def FormFontsDictionary():
    from RTLReportLab.pdfbase.pdfdoc import PDFDictionary
...
def FormFont(BaseFont, Name):
    from RTLReportLab.pdfbase.pdfdoc import PDFName
...
def TextField(title, value, xmin, ymin, xmax, ymax, page,
    ...
    from RTLReportLab.pdfbase.pdfdoc import PDFString, PDFName
    Flags = 0
    if multiline:
...
def SelectField(title, value, options, xmin, ymin, xmax, ymax, page,
    ...
    from RTLReportLab.pdfbase.pdfdoc import PDFString, PDFName, PDFArray
