...
nothing more than "RTLReportLab.whatever..."
"""

import sys, os, fnmatch, re, functools
from configparser import ConfigParser
import unittest, random
from RTLReportLab.lib.utils import isCompactDistro, __rl_loader__, rl_isdir, asUnicode
from RTLReportLab.rl_config import invariant as rl_invariant

def invariantSeed(n):
    if rl_invariant: random.seed(n)

def haveRenderPM():
    from RTLReportLab.graphics.renderPM import _getPMBackend, RenderPMError
    try:
...
def setOutDir(name):
    ...
    import RTLReportLab
    RL_HOME=RTLReportLab.__path__[0]
