from RTLReportLab.graphics.shapes import Drawing, Polygon, Line
...
def _getLit(col,shd=None,lighting=0.1):
    if shd is None:
        from RTLReportLab.lib.colors import Whiter
...
if __name__=='__main__':
    ...
    from RTLReportLab.lib.colors import lightgrey, pink
    D = Drawing(300,200)
