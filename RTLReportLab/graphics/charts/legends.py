...
from RTLReportLab.lib.validators import isNumber, OneOf, isString, isColorOrNone,\
...
from RTLReportLab.graphics.widgetbase import Widget, TypedPropertyCollection, PropHolder
from RTLReportLab.graphics.shapes import Drawing, Group, String, Rect, Line, STATE_DEFAULTS
from RTLReportLab.graphics.widgets.markers import uSymbol2Symbol, isSymbol
from RTLReportLab.lib.utils import isSeq, find_locals, isStr, asNative
from RTLReportLab.graphics.shapes import _baseGFontName
...
class Legend(Widget):
    ...
    RTLReportLab.lib.colors. Otherwise the object passed instead is
...
class TotalAnnotator(LegendColEndCallout):
    ...
    def __call__(self,legend, g, x, xt, y, width, lWidth):
        from RTLReportLab.graphics.shapes import String, Line
        fontSize = self.fontSize
        fontName = self.fontName
        fillColor = self.fillColor
        strokeColor = self.strokeColor
