...
from RTLReportLab.platypus.flowables import *
from RTLReportLab.platypus.flowables import _ContainerSpace
from RTLReportLab.lib.units import inch
from RTLReportLab.lib import rl_safe_eval
from RTLReportLab.platypus.paragraph import Paragraph
from RTLReportLab.platypus.frames import Frame
from RTLReportLab.rl_config import defaultPageSize, verbose, invariant
import RTLReportLab.lib.sequencer
from RTLReportLab.pdfgen import canvas
from RTLReportLab.lib.utils import isSeq, encode_label, decode_label, annotateException, strTypes
...
import sys
import logging
logger = logging.getLogger("RTLReportLab.platypus")
...
def _evalMeasurement(n):
    if isinstance(n,str):
        from RTLReportLab.platypus.paraparser import _num
        n = _num(n)
        if isSeq(n): n = n[1]
    return n
...
class BaseDocTemplate:
    ...
    def _makeCanvas(self, filename=None, canvasmaker=canvas.Canvas):
        ...
        *NB* only the canvases created in self._startBuild will actually be used
        ...
        self.seq = RTLReportLab.lib.sequencer.Sequencer()
        ...
        from RTLReportLab.pdfbase.pdfdoc import (
...
if __name__ == '__main__':
    from RTLReportLab.lib.styles import _baseFontName, _baseFontNameB
    def myFirstPage(canvas, doc):
        from RTLReportLab.lib.colors import red
    ...
    def run():
        ...
        from RTLReportLab.platypus.doctemplate import SimpleDocTemplate

        #need a style
        normal = ParagraphStyle('normal')
        normal.firstLineIndent = 18
        normal.spaceBefore = 6
        from RTLReportLab.lib.randomtext import randomText
        import random
        for i in range(15):
