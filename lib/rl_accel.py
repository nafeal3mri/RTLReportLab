...
__all__ = list(filter(None,'''
        ...
        '''.split()))
import RTLReportLab
testing = getattr(RTLReportLab,'_rl_testing',False)
del RTLReportLab
...
if _py_funcs:
    from RTLReportLab.lib.utils import isUnicode, isSeq, rawBytes, asNative, asBytes
...
if __name__=='__main__':
    ...
    for cmd,xs  in (
        ...
        for modname in '_rl_accel','RTLReportLab.lib.rl_accel':
            s = ';'.join((
