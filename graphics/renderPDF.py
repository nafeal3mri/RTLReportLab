...
from RTLReportLab.pdfgen.canvas import Canvas
from RTLReportLab.pdfbase.pdfmetrics import stringWidth
from RTLReportLab import rl_config
from RTLReportLab.graphics.renderbase import Renderer, getStateDelta, renderScaledDrawing, STATE_DEFAULTS
...
def drawToFile(d, fn, msg="", showBoundary=rl_config._unset_, autoSize=1, **kwds):
    ...
    if metadataPath:
        from RTLReportLab.pdfbase.pdfdoc import XMP
...
def test(outDir='pdfout',shout=False):
    from RTLReportLab.graphics.shapes import _baseGFontName, _baseGFontNameBI
