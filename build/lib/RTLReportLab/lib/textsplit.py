...
from RTLReportLab.rl_config import _FUZZ
from RTLReportLab.lib.utils import isUnicode
...
def getCharWidths(word, fontName, fontSize):
    ...
    [6.0, 6.0, 6.0, 6.0, 6.0]
    >>> from RTLReportLab.pdfbase.cidfonts import UnicodeCIDFont
...
if __name__=='__main__':
    import doctest
    from RTLReportLab.lib import textsplit
