...
from RTLReportLab.lib.utils import bytestr, isUnicode, char2int, isStr, isBytes
from RTLReportLab.lib.abag import ABag
from RTLReportLab.pdfbase import pdfmetrics, pdfdoc
from RTLReportLab import rl_config
from RTLReportLab.lib.rl_accel import hex32, add32, calcChecksum, instanceStringWidthTTF, fp_str
from RTLReportLab.rl_config import register_reset, unShapedFontGlob
...
def TTFOpenFile(fn):
    ...
    '''
    from RTLReportLab.lib.utils import rl_isfile, open_for_read
    try:
