...
from RTLReportLab.lib.utils import ImageReader, isUnicode
from RTLReportLab.lib.rl_accel import asciiBase85Encode, asciiBase85Decode
...
def readJPEGInfo(image):
    ...
    import struct
    from RTLReportLab.pdfbase.pdfdoc import PDFError
