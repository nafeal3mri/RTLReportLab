...
def _defaults_init():
    ...
    RTLReportLab.rl_settings.py
    RTLReportLab.local_rl_settings.py
    ...
    _DEFAULTS={}
    rl_exec('from RTLReportLab.rl_settings import *',_DEFAULTS)

    _overrides=_DEFAULTS.copy()
    try:
        rl_exec('from RTLReportLab.local_rl_settings import *',_overrides)
...
def _startUp():
    ...
    from RTLReportLab.lib import pagesizes
    from RTLReportLab.lib.utils import rl_isdir
    ...
    import RTLReportLab
    D = {'REPORTLAB_DIR': os.path.abspath(os.path.dirname(RTLReportLab.__file__)),
        'CWD': os.getcwd(),
