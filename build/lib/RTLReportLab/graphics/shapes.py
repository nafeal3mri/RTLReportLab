...
from RTLReportLab.platypus import Flowable
from RTLReportLab.rl_config import shapeChecking, verbose, defaultGraphicsFontName as _baseGFontName, _unset_, decimalSymbol
from RTLReportLab.lib import logger
from RTLReportLab.lib import colors
from RTLReportLab.lib.validators import *
from RTLReportLab.lib.utils import isSeq, asBytes
...
from RTLReportLab.lib.fonts import tt2ps
from RTLReportLab.pdfgen.canvas import FILL_EVEN_ODD, FILL_NON_ZERO
...
class Shape(_SetKeyWordArgs,_DrawTimeResizeable):
    ...
    if shapeChecking:
        ...
        def __setattr__(self, attr, value):
            ...
            validateSetattr(self,attr,value)    #from RTLReportLab.lib.attrmap
...
class Drawing(Group, Flowable):
    ...
    def _renderPy(self):
        I = {
            'RTLReportLab.graphics.shapes': ['_DrawingEditorMixin','Drawing','Group'],
            'RTLReportLab.lib.colors': ['Color','CMYKColor','PCMYKColor'],
            }
    ...
    def draw(self,showBoundary=_unset_):
        ...
        be used directly."""
        from RTLReportLab.graphics import renderPDF
    ...
    def save(self, formats=None, verbose=None, fnRoot=None, outDir=None, title='', **kw):
        ...
        for bmFmt in self._bmModes:
            if bmFmt in plotMode:
                from RTLReportLab.graphics import renderPM
        ...
        if 'eps' in plotMode:
            try:
                ...
                from RTLReportLab.graphics import renderPS
            filename = fnroot+'.eps'
        ...
        if 'svg' in plotMode:
            from RTLReportLab.graphics import renderSVG
            filename = fnroot+'.svg'
