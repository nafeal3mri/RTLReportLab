...
from RTLReportLab.lib.utils import commasplit, escapeOnce, encode_label, decode_label, strTypes, asUnicode, asNative
from RTLReportLab.lib.styles import ParagraphStyle, _baseFontName
from RTLReportLab.lib import sequencer as rl_sequencer
from RTLReportLab.platypus.paragraph import Paragraph
from RTLReportLab.platypus.doctemplate import IndexingFlowable
from RTLReportLab.platypus.tables import TableStyle, Table
from RTLReportLab.platypus.flowables import Spacer
...
class SimpleIndex(IndexingFlowable):
    ...
    def setup(self, style=None, dot=None, tableStyle=None, headers=True, name=None, format='123', offset=0):
        ...
        if name is None:
            from RTLReportLab.platypus.paraparser import DEFAULT_INDEX_NAME as name
        self.name = name
