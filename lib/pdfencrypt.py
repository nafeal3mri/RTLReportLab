...
from RTLReportLab.lib.utils import asBytes, int2Byte, rawBytes, asNative
from RTLReportLab.pdfgen.canvas import Canvas
from RTLReportLab.pdfbase.pdfdoc import PDFObject
...
class StandardEncryptionDictionary(PDFObject):
    ...
    def format(self, document):
        ...
        from RTLReportLab.pdfbase.pdfdoc import DummyDoc, PDFDictionary, PDFName
        dummy = DummyDoc()
...
def computeO(userPassword, ownerPassword, revision):
    from RTLReportLab.lib.arciv import ArcIV
...
def encryptPdfInMemory(inputPDF,
    ...
    try:
        ...
        raise ImportError('''RTLReportLab.lib.pdfencrypt.encryptPdfInMemory failed because rlextra cannot be imported.
