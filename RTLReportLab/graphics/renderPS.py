...
from RTLReportLab.pdfbase.pdfmetrics import getFont, stringWidth, unicode2T1 # for font info
from RTLReportLab.lib.utils import asBytes, char2int, rawBytes, asNative, isUnicode
from RTLReportLab.lib.rl_accel import fp_str
from RTLReportLab.graphics.renderbase import Renderer, getStateDelta, renderScaledDrawing
from RTLReportLab.graphics.shapes import STATE_DEFAULTS
from RTLReportLab import rl_config
from RTLReportLab.pdfgen.canvas import FILL_EVEN_ODD
...
''' % (self.width,self.height))
        ...
        if _f is not f:
            _f.close()
            from RTLReportLab.lib.utils import markfilename
    ...
    def setDash(self, array=[], phase=0):
        ...
        # copied and modified from RTLReportLab.canvas
        psoperation = "setdash"
...
from RTLReportLab.graphics.shapes import *
...
##              'font_size':'_fontSize'}
    ...
    def drawPath(self, path, fillMode=None):
        from RTLReportLab.graphics.shapes import _renderPath
        c = self._canvas
...
##              warnOnce('Fill opacity not done yet')
    ...
    def drawImage(self, image):
        from RTLReportLab.lib.utils import ImageReader
...
def test(outDir='epsout',shout=False):
    from RTLReportLab.graphics import testshapes
    from RTLReportLab.rl_config import verbose
