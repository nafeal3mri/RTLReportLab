...
from RTLReportLab.graphics import shapes
...
class PropHolder:
    ...
    def getProperties(self,recur=1):
        ...
        from RTLReportLab.lib.validators import isValidChild
...
def test():
    from RTLReportLab.graphics.charts.piecharts import WedgeProperties
    wedges = TypedPropertyCollection(WedgeProperties)
