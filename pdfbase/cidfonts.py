...
from RTLReportLab.pdfbase._cidfontdata import allowedTypeFaces, allowedEncodings, CIDFontInfo, \
...
from RTLReportLab.lib.rl_accel import escapePDF
from RTLReportLab.rl_config import CMapSearchPath
from RTLReportLab.lib.utils import isSeq, isBytes
...
class CIDEncoding(pdfmetrics.Encoding):
    ...
    def __init__(self, name, useCache=1):
        ...
        if not DISABLE_CMAP:
            if useCache:
                from RTLReportLab.lib.utils import get_rl_tempdir
...
if __name__=='__main__':
    import doctest
    from RTLReportLab.pdfbase import cidfonts
