...
from RTLReportLab.pdfbase.pdfmetrics import stringWidth # for font info
from RTLReportLab.lib.rl_accel import fp_str
from RTLReportLab.lib.utils import asNative
from RTLReportLab.graphics.renderbase import getStateDelta, Renderer, renderScaledDrawing
from RTLReportLab.graphics.shapes import STATE_DEFAULTS, Path, UserNode
from RTLReportLab.graphics.shapes import * # (only for test0)
from RTLReportLab import rl_config
from RTLReportLab.lib.utils import RLString, isUnicode, isBytes
...
def test(outDir='out-svg'):
    ...
    from RTLReportLab.graphics.testshapes import getDrawing01
    d = getDrawing01()
    drawToFile(d, os.path.join(outDir,"test.svg"))

    from RTLReportLab.lib.corp import RL_CorpLogo
    from RTLReportLab.graphics.shapes import Drawing
