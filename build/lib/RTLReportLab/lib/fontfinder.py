...
from RTLReportLab.lib.utils import asBytes, asNative as _asNative
...
from RTLReportLab.lib.utils import rl_isdir, rl_isfile, rl_listdir, rl_getmtime
class FontFinder:
    ...
    def _getCacheFileName(self):
        ...
        from RTLReportLab.lib.utils import get_rl_tempfile
            ...
            for fileName in fileNames:
                ...
                if ext.lower() in EXTENSIONS:
                    ...
                    if ext in ('otf', 'pfa'):
                        ...
                        from RTLReportLab.pdfbase.ttfonts import TTFontFile, TTFError
                        try:
                        ...
                        if rl_isfile(os.path.join(dirName, root + '.afm')):
                            ...
                            self._skippedFiles.append(fileName)
                            continue
                        from RTLReportLab.pdfbase.pdfmetrics import parseAFMFile
...
def test():
    ...
    rlFontDir = os.path.join(os.path.dirname(RTLReportLab.__file__), 'fonts')
