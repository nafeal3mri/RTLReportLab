...
from RTLReportLab.lib.validators import isNumber, isListOfNumbersOrNone,\
...
from RTLReportLab.graphics.shapes import Group, Drawing, Ellipse, Wedge, String, STATE_DEFAULTS, ArcPath, Polygon, Rect, PolyLine, Line
from RTLReportLab.graphics.widgetbase import TypedPropertyCollection, PropHolder
...
class LegendedPie(Pie):
    ...
    def __init__(self,**kwds):
        ...
        #set up the legends
        from RTLReportLab.graphics.charts.legends import Legend
        self.legend1 = Legend()
...
from RTLReportLab.graphics.charts.utils3d import _getShaded, _2rad, _360, _180_pi
