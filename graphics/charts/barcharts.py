...
from RTLReportLab.lib.validators import isNumber, isNumberOrNone, isColorOrNone, isString,\
            SequenceOf, isBoolean, isStringOrNone,\
            NoneOr, isListOfNumbersOrNone, EitherOr, OneOf, isInt
from RTLReportLab.lib.utils import isStr, yieldNoneSplits
from RTLReportLab.graphics.widgets.markers import uSymbol2Symbol, isSymbol
from RTLReportLab.lib.attrmap import AttrMap, AttrMapValue
...
from RTLReportLab.graphics.shapes import Line, Rect, Group, Drawing, PolyLine
from RTLReportLab.graphics.charts.axes import XCategoryAxis, YValueAxis, YCategoryAxis, XValueAxis
from RTLReportLab.graphics.charts.textlabels import BarChartLabel, NoneOrInstanceOfNA_Label
from RTLReportLab.graphics.charts.areas import PlotArea
from RTLReportLab.graphics.charts.legends import _objStr
from RTLReportLab import cmp
...
class BarChart3D(BarChart):
    ...
    def makeBars(self):
        from RTLReportLab.graphics.charts.utils3d import _draw_3d_bar
...
def sampleSymbol1():
    ...
    from RTLReportLab.graphics.widgets.grids import ShadedRect
    sym1 = ShadedRect()
