...
from RTLReportLab import rl_config
from RTLReportLab.pdfbase import pdfdoc
from RTLReportLab.pdfbase import pdfmetrics
from RTLReportLab.pdfbase.ttfonts import ShapedStr, shapeFragWord
from RTLReportLab.pdfgen  import pathobject
from RTLReportLab.pdfgen.textobject import PDFTextObject, _PDFColorSetter, bidiShapedText
from RTLReportLab.lib.colors import black, _chooseEnforceColorSpace, Color, CMYKColor, toColor
from RTLReportLab.lib.utils import ImageReader, isSeq, isStr, isUnicode, _digester, asUnicode
from RTLReportLab.lib.abag import ABag
from RTLReportLab.lib.rl_accel import fp_str, escapePDF
from RTLReportLab.lib.boxstuff import aspectRatioFix
...
def _annFormat(D,color,thickness,dashArray,hradius=0,vradius=0):
    from RTLReportLab.pdfbase.pdfdoc import PDFArray
...
def _buildColorFunction(colors, positions):
    from RTLReportLab.pdfbase.pdfdoc import PDFExponentialFunction, PDFStitchingFunction
...
class Canvas(_PDFColorSetter):
    ...
    Example:: 
       ...
       from RTLReportLab.pdfgen import canvas
       c = canvas.Canvas("hello.pdf")
       from RTLReportLab.lib.units import inch
    ...
    def setEncrypt(self, encrypt):
        ...
        If encrypt is an instance of RTLReportLab.lib.pdfencrypt.StandardEncryption, this object is
        used to encrypt the pdf. This allows more finegrained control over the encryption settings.
        '''
        if encrypt:
            from RTLReportLab.lib import pdfencrypt
            if isStr(encrypt): #encrypt is the password itself
                ...
                raise TypeError('Expected string or instance of RTLReportLab.lib.pdfencrypt.StandardEncryption as encrypt parameter but got %r' % encrypt)
    ...
    def drawInlineImage(self, image, x,y, width=None,height=None,
        ...
        from RTLReportLab.pdfgen.pdfimages import PDFImage
    ...
    def linkURL(self, url, rect, relative=0, thickness=0, color=None, dashArray=None, kind="URI", **kw):
        ...
        from RTLReportLab.pdfbase.pdfdoc import PDFDictionary, PDFName, PDFArray, PDFString
    ...
    def linearGradient(self, x0, y0, x1, y1, colors, positions=None, extend=True):
        ...
        from RTLReportLab.pdfbase.pdfdoc import PDFAxialShading
    ...
    def radialGradient(self, x, y, radius, colors, positions=None, extend=True):
        #this code contributed by Peter Johnson <johnson.peter@gmail.com>
        from RTLReportLab.pdfbase.pdfdoc import PDFRadialShading
        colorSpace, ncolors = _normalizeColors(colors)
        fcn = _buildColorFunction(ncolors, positions)
    ...
    def setViewerPreference(self,pref,value):
        ...
        if VP is None:
            from RTLReportLab.pdfbase.pdfdoc import ViewerPreferencesPDFDictionary
    ...
    def setCatalogEntry(self,key,value):
        from RTLReportLab.pdfbase.pdfdoc import PDFDictionary, PDFArray, PDFString
        if isStr(value):
    ...
    def addPageLabel(self, pageNum, style=None, start=None, prefix=None):
        ...
        if PL is None:
            from RTLReportLab.pdfbase.pdfdoc import PDFPageLabels
            PL = catalog.PageLabels = PDFPageLabels()

        from RTLReportLab.pdfbase.pdfdoc import PDFPageLabel
    ...
    def acroForm(self):
        ...
        try:
            ...
            from RTLReportLab.pdfbase.acroform import AcroForm
