...
from RTLReportLab.lib.validators import isInt, isNumber, isString, isColorOrNone, isBoolean, EitherOr, isNumberOrNone
from RTLReportLab.lib.attrmap import AttrMap, AttrMapValue
from RTLReportLab.lib.colors import black
from RTLReportLab.lib.utils import rl_exec
from RTLReportLab.graphics.shapes import Rect, Group, String
...
from RTLReportLab.graphics.barcode.widgets import BarcodeStandard93
...
BarcodeI2of5 = _BCW(
    ...
    'RTLReportLab.graphics.barcode.common',
    1234,
    _tests = [
        '12',
        '1234',
...
BarcodeCode128 = _BCW("""Code 128 encodes any number of characters in the ASCII character set.""",
                ...
                'RTLReportLab.graphics.barcode.code128',
                "AB-12345678",
...
BarcodeStandard93=_BCW("""This is a compressed form of Code 39""",
                        ...
                        'RTLReportLab.graphics.barcode.code93',
                        "CODE 93",
                        )
...
BarcodeStandard39=_BCW("""Code39 is widely used in non-retail, especially US defence and health.
                        ...
                        'RTLReportLab.graphics.barcode.code39',
                        "A012345B%R",
                        )
...
BarcodeFIM=_BCW("""
                ...
                'RTLReportLab.graphics.barcode.usps',
                "A",
                )
...
BarcodeUSPS_4State=_BCW('',
                        ...
                        'RTLReportLab.graphics.barcode.usps4s',
...
BarcodeECC200DataMatrix = _BCW(
    ...
    'RTLReportLab.graphics.barcode.ecc200datamatrix',
