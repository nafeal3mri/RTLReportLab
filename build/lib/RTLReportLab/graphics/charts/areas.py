...
from RTLReportLab.lib.validators import isNumber, isColorOrNone, isNoneOrShape
from RTLReportLab.graphics.widgetbase import Widget
from RTLReportLab.graphics.shapes import Rect, Group, Line, Polygon
from RTLReportLab.lib.attrmap import AttrMap, AttrMapValue
from RTLReportLab.lib.colors import grey
            ...
            if (strokeWidth and strokeColor) or fillColor:
                ...
                if _3d_dy is not None:
                    ...
                    if fillColor and not strokeColor:
                        from RTLReportLab.lib.colors import Blacker
