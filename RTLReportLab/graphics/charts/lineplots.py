...
from RTLReportLab.lib.validators import *
from RTLReportLab.lib.attrmap import *
from RTLReportLab.lib.utils import flatten, isStr
from RTLReportLab.graphics.shapes import Drawing, Group, Rect, PolyLine, Polygon, _SetKeyWordArgs
from RTLReportLab.graphics.widgetbase import TypedPropertyCollection, PropHolder, tpcGetItem
from RTLReportLab.graphics.charts.textlabels import Label
from RTLReportLab.graphics.charts.axes import XValueAxis, YValueAxis, AdjYValueAxis, NormalDateXValueAxis
from RTLReportLab.graphics.charts.utils import *
from RTLReportLab.graphics.widgets.markers import uSymbol2Symbol, makeMarker
from RTLReportLab.graphics.widgets.grids import Grid, DoubleGrid, ShadedPolygon
from RTLReportLab.pdfbase.pdfmetrics import stringWidth, getFont
from RTLReportLab.graphics.charts.areas import PlotArea
...
from RTLReportLab.graphics.charts.linecharts import AbstractLineChart
class LinePlot(AbstractLineChart):
    ...
    def addCrossHair(self,name,xv,yv,strokeColor=colors.black,strokeWidth=1,beforeLines=True):
        from RTLReportLab.graphics.shapes import Group, Line
...
class LinePlot3D(LinePlot):
    ...
    def makeLines(self):
        ...
        from RTLReportLab.graphics.charts.linecharts import _FakeGroup
        F = _FakeGroup()

        from RTLReportLab.graphics.charts.utils3d import _make_3d_line_info, find_intersections
        if self.xValueAxis.style!='parallel_3d':
