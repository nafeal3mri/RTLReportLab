...
from RTLReportLab.pdfbase.ttfonts import ShapedStr
from RTLReportLab.lib.utils import open_and_read, isBytes, rl_exec
...
def __makeTextPathsCode__(tp=None, _TP = ('freetype','_renderPM')):
    from RTLReportLab.rl_config import textPaths, renderPMBackend
