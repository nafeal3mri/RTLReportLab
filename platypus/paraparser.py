...
from RTLReportLab.lib.utils import ImageReader, annotateException, encode_label, asUnicode
from RTLReportLab.lib.colors import toColor, black
from RTLReportLab.lib.fonts import tt2ps, ps2tt
from RTLReportLab.lib.enums import TA_LEFT, TA_RIGHT, TA_CENTER, TA_JUSTIFY
from RTLReportLab.lib.units import inch,mm,cm,pica
from RTLReportLab.rl_config import platypus_link_underline
...
def _greekConvert(data):
    global _greek2Utf8
    if not _greek2Utf8:
        from RTLReportLab.pdfbase.rl_codecs import RL_Codecs
        import codecs
        #our decoding map
...
class ParaParser(HTMLParser):
    ...
    def _setup_for_parse(self,style):
        self._seq = RTLReportLab.lib.sequencer.getSequencer()
...
if __name__=='__main__':
    from RTLReportLab.platypus import cleanBlockQuotedText
